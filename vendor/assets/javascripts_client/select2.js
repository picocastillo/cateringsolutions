...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            // EMMA no se para que agregan este label que causa que capybara explota xq encuentra 2 elementos
            ...
            this.focusser.on("keydown", this.bind(function (e) {
                ...
                if (this.opts.openOnEnter === false && e.which === KEY.ENTER) {
                    // EMMA los combos normales al presionar enter estando cerrado submitean el form. La linea siguiente impedia ese comportamiento en los select2.
                    // killEvent(e);
                    return;
                }
            ...
            // EMMA Esto permite que al clickear en el label haga foco en el select2. Andaba en v3.3.1 pero al actualizar a la v3.4.6 dejó de andar
            this.opts.element.on('focus', function() {
                container.find(".select2-focusser").focus();
            })
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            // EMMA acá tb no se para que creaban este label la cuestion es q causaba problemas con capybara
            // this.search.prev()
            ...
            // EMMA Esto permite que al clickear en el label haga foco en el select2. Andaba en v3.3.1 pero al actualizar a la v3.4.6 dejó de andar
            this.opts.element.on('focus', function() {
                _this.container.find('.select2-input').focus();
            })
    ...
    $.fn.select2.defaults = {
        ...
        formatResult: function(result, container, query, escapeMarkup) {
            var markup=[];
            markMatch(this.resultText(result), query.term, markup, escapeMarkup);
            return markup.join("");
        },
